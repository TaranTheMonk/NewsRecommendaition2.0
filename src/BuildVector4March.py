...
class SqlFunction():
    ...
    def sendVector(self, userNewsProfile):
        ...
        query = "insert into user_news_profile_March (device_id, history, TypeVec, SourceVec) values (%s, %s, %s, %s)"
...
def buildVecFromLog():
    ...
    userNewsCollection = getNewsRecord.minLog('2017-03-01', '2017-03-29')
